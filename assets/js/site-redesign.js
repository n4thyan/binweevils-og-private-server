(function () {
    ...
    if (document.querySelector('[data-account-live]')) {
        ...
        // Refresh immediately when the player returns to the site / tab regains
        // focus, so currency and progression stay current without a reload.
        window.addEventListener('focus', function () { refreshAccountState(); });
        document.addEventListener('visibilitychange', function () {
            if (!document.hidden) refreshAccountState();
        });
    }
