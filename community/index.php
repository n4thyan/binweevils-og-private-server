...
<section class="bw-home-grid">
    ...
    <article class="bw-panel bw-feature-card">
        ...
        <h2>Nest News</h2>
        <p>Read the same server-controlled stories published to Nest News inside the game.</p>
        <a class="bw-button bw-button--blue bw-button--small" href="/bulletin/">Open Bin Bulletin</a>
    </article>
